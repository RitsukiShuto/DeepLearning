# Crested by RitsukiShuto on 2020/04/18.
# sklearn digits
#
# import lib
...
# 目的関数を定義
optimizer = chainer.optimizers.SGD(lr=0.025)
print(optimizer.setup(net))

# ニューラルネットワークを訓練
n_epoch = 20        # エポック数 収束するまで
n_batchsize = 64    # バッチサイズ
iteration = 0
...
chainer.serializers.save_npz('my_digits.net', net)
...
chainer.serializers.load_npz('my_digits.net', loaded_net)
